...
export class GameService {
    ...
    async participantSuccess(userSecureId: string, gameSecureId: string, index: number) {
        const game = await this.prisma.game.findUnique({
            where: {
                secureId: gameSecureId
            }
    ...
    async participantSkip(userSecureId: string, gameSecureId: string, index: number) {
        const game = await this.prisma.game.findUnique({
            where: {
                secureId: gameSecureId
            }
